                ...
                <div class="modal-body">
                    <div class="p-2">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <div class="input-group input-group-seamless">
                                    ...
                                    <input type="text" 
                                           ...
                                           ref="eventTitle" autofocus />
                                    <p class=error>{{ titleError }}</p>
                                </div>
                            </li>

                            <li class="list-group-item">
                                <schedule-category-select :schedule_categories="schedule_categories"
                            ...
                            <li class="list-group-item">
                                <div class="input-group input-group-seamless">
                                    <input type="checkbox" v-model="event.display_driver_name"
                                        checked="checked" />ドライバー名をタイトルに表示
                                </div>
                            </li>

                            <li class="list-group-item">
                                <driver-select :drivers="drivers" 
                            ...
                            <li class="list-group-item">
                                <div class="input-group input-group-seamless">
                                    <input type="checkbox" id="all_day" v-model="event.all_day" checked="checked" />終日
                            ...
                            <li class="list-group-item">
                                <div class="input-group input-group-seamless">
                                    ...
                                    <input type="date" 
                                           ...
                                           ref="eventStartDate" autofocus />
                                    <input v-if="!event.all_day" 
                                           type="time" 
                                           class="form-control w-100 modal-title"
                            ...
                            <li class="list-group-item">
                                <div class="input-group input-group-seamless">
                                    <p>終了</p>
                                    <input type="date" class="form-control w-100 modal-title" v-model="event.end_date"
                                        ref="eventEndDate" autofocus />
                                    <p class=error>{{ dateError }}</p>
                                    <input v-if="!event.all_day" type="time" class="form-control w-100 modal-title"
                                        v-model="event.end_time" ref="eventEndTime" autofocus />
                                </div>
                            </li>
                            ...
                            <li class="list-group-item">
                                <div class="input-group input-group-seamless">
                                    <p>品目</p>
                                    <input type="text" class="form-control w-100 modal-title" v-model="event.item"
                                        placeholder="Add item ..." ref="eventItem" autofocus />
                            ...
                            <li class="list-group-item">
                                <div class="input-group input-group-seamless">
                                    <p>積み込み先</p>
                                    <input type="text" class="form-control w-100 modal-title"
                                        v-model="event.pickup_location" placeholder="Add pickup location ..."
                                        ref="eventPickupLocation" autofocus />
                            ...
                            <li class="list-group-item">
                                <div class="input-group input-group-seamless">
                                    ...
                                    <input type="text" 
                                        ...
                                        ref="eventDropoffLocation" autofocus />
                            ...
                            <li class="list-group-item" v-else>
                                <div class="input-group input-group-seamless">
                                    <p>添付ファイルを選択</p>
                                    <input @change="selectedFileForUpload" 
                                           type="file" 
                                           name="file" />
                                </div>
                            </li>
                            ...
                            <li class="list-group-item">
                                <div class="input-group input-group-seamless">
                                    ...
                                    <textarea type="text" 
                                              ...
                                              ref="eventDescription" autofocus></textarea>
                                </div>
                            </li>
...
export default {
    ...
    methods: {
        ...
        saveEvent() {
            //開始日≦終了日となるように・終日にチェックがないとき時間まで入力するように
            this.dateValidation(this.event);
